...
public class CirclePagerIndicatorDecoration extends RecyclerView.ItemDecoration {
    private int colorActive = Color.parseColor("#EF4135");
    private int colorInactive = Color.parseColor("#DDDDDD");

    /*This class is used for representing the pager indicator that is shown on OnboardingScreens*/
     ...
     */
    private final int mIndicatorHeight = (int) (DP * 12);
