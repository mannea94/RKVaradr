...
public class Constants {
    ...
    //URLs
    public static String BASE_VARDAR_URL = "https://rkvardar.com.mk/";
    public static String VARDAR_UPLOADS_URL = "https://rkvardar.com.mk/wp-content/uploads/";
    ...
    public static String LEAGUE_EHF_TV_URL = "https://www.ehftv.com/";


    //Social Media
    public static String FACEBOOK_URL = "https://www.facebook.com/rkvardar";
    public static String INSTAGRAM_URL = "https://www.instagram.com/rkvardar1961/";
    ...
    public static String LEAGUE_EHF_PLUS_EXTRA = "ehf_plus";
    public static String LEAGUE_EHF_TV_EXTRA = "ehf_tv";
    public static String SPONSOR_EXTRA = "sponsor";
